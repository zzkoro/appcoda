            ...
            VStack(spacing: 0) {
                ...
                VStack(alignment: .leading) {
                    ...
                    HStack(spacing: 0) {
                        ...
                        .frame(minWidth: 0.0, maxWidth: .infinity)
                        .padding()
                        .background(paymentFormViewModel.type == .expense ? Color("ExpenseCard") : Color(.systemBackground))
                ...
                // Location
                FormTextField(name: "Location2 (Optional)", placeHolder: "Where do you spend?", value: $paymentFormViewModel.location)
                    .padding(.top)
...
struct PaymentFormView_Previews: PreviewProvider {
    static var previews: some View {
        ...
        return Group {
            ...
            FormTextField(name: "NAME", placeHolder: "Enter your payment", value: .constant("")).previewLayout(.sizeThatFits).previewDisplayName("Form Text Field")
            
            FormDateField(name: "DATE", value: .constant(Date())).previewLayout(.sizeThatFits).previewDisplayName("Form Date Field")
            
            FormTextEditor(name: "TEXTEDITOR", value: .constant("")).previewLayout(.sizeThatFits).previewDisplayName("Form TextEditor Field")
            
            ValidationErrorText(text: "Please enter the payment name")
                .previewLayout(.sizeThatFits).previewDisplayName("Validation Error")
